...
- [../.agents/skills/web-design-guidelines/SKILL.md](../.agents/skills/web-design-guidelines/SKILL.md)：管理端 UI 设计审查 Agent skill（Vercel Web Interface Guidelines + 本仓库产品设计规则）。
